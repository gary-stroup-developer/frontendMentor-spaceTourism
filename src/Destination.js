        ...
        return (
            <div className="Destination">
                ...
                <div className="Destination-image-container">
                    <p className="Destination-decision"><span id="Destination-span">01</span> Pick your destination</p>
                    <img className="Destination-image" src= {images[name]} alt={name} />
                </div>
            <div className="Destination-navigation-details">
                <div className="Destination-links-container"> {
                    ...
                    <div className="Destination-info">
                        <p id="Destination-name">{this.props.detail ? name : ""}</p>
                        <p id="Destination-description">{this.props.detail ? description : ""}</p>
                        <div className="hr" />
                        <div className="Destination-info-fact-container">
                            <div className="Destination-info-fact">
                                <p>avg. distance</p>
                                <p className="Destination-info-fact-title" id="Destination-distance">{this.props.detail ? distance : ""}</p>
                            </div>
                            <div className="Destination-info-fact">
                                <p> estimated travel time</p>
                                <p className="Destination-info-fact-title" id="Destination-travel">{this.props.detail ? travel : ""}</p>  
                            </div> 
                        </div>  
                    </div>
                </div>
